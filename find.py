...
draw_graph(G_sub,alpha=0.5,node_scale=30,figsize=(10,10))
# 30
...
partition = community_louvain.best_partition(G_main)         # Louvain算法划分社区
# partition = python-louvain.best_partition(G_main)
